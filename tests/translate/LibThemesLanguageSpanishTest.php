...
// to run test: sail artisan test --filter LibThemesLanguageSpanishTest
class LibThemesLanguageSpanishTest extends TestCase
{
    /**
    ...
    // Caminhos para os arquivos de array em diferentes diretórios
	{
        ...
        $path = base_path() . '/vendor/codificar/themes/src/translations';
